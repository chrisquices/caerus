                    ...
                    <div class="container">
                        <div class="panel-white mb-30">
                            <div class="box-padding">
                                <h6 class="color-text-paragraph-2 mb-30">Complete el formulario para crear una nueva empresa</h6>
                                <form action="{{ route('backend.companies.store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="box-profile-image">
                                                <div class="img-profile">
                                                    <img src="{{ asset('assets/backend/imgs/photo-placeholder.jpg') }}" alt="jobBox"
                                                         id="photo-preview"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="box-profile-image">
                                                <div class="img-profile">
                                                    <img src="{{ asset('assets/backend/imgs/banner-placeholder.jpg') }}" alt="jobBox"
                                                         id="banner-preview"
