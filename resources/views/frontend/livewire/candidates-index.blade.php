                        ...
                        <div class="col-xl-6 col-lg-5">
                            <span class="font-sm text-showing color-text-paragraph">
                                @if($candidates->total() > 0)
                                    ...
                                    de {{ $candidates->total() }} candidatos
                                @else
                                    Mostrando
                                    0-0
                                    de {{ $candidates->total() }} candidatos
                        ...
                        @if($candidates->total() > 0)
                            @foreach($candidates as $candidate)
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12"
                                     onclick="window.location.href = '{{ route('frontend.candidates.show', ['candidate' => $candidate->id]) }}'">
                                    <div class="card-grid-2 hover-up cursor-pointer">
                                        <div class="card-grid-2-image-left">
                                            ...
                                            <div class="right-info">
                                                <a class="name-job"
                                                   href="#">{{ $candidate->user->name }} {{ $candidate->user->last_name }}</a>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 text-end">
                                                        <div class="btn btn-apply-now">
                                                            <a href="#" class="text-primary text-apply-now" style="font-weight: 500;">Ver
                                                                Perfil</a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-grid-2 hover-up cursor-pointer">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-6 col-sm-12">
                                                <div class="card-grid-2-image-left">
                                                    <div class="image-box"><img src="{{ $candidate->user->photo_url }}" alt="jobBox"></div>
                                                    <div class="right-info">
                                                        <a class="name-job" href="">LinkedIn</a>
                                                        <span class="text-profession p-0">
                                                    {{ $candidate->city->department->name }}, {{ $candidate->city->name }}
                                                </span>
                                                    </div>
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <p class="font-xs color-text-paragraph-2 mt-2 mb-0">{{ $candidate->about_me_trimmed_extended ?? 'Sin Descripción' }}</p>

                                            @if($candidate->candidateSkills->count() > 0 || $candidate->candidateLanguages->count() > 0)
                                                <div class="mt-20">
            ...
            <div class="sidebar-shadow none-shadow mb-30">
                <div class="sidebar-filters">
                    ...
                    <div class="filter-block mb-30">
                        <h5 class="medium-heading mb-15">Profesiones</h5>
                        <div class="form-group select-style select-style-icon">
                            <select class="form-control form-icons select-active" id="profession_id" wire:model="profession_selected">
                    ...
                    <div class="filter-block mb-30">
                        <h5 class="medium-heading mb-15">Habilidades</h5>
                        <div class="form-group select-style select-style-icon">
                            <select class="form-control form-icons select-active" id="skill_id" wire:model="skill_selected">
                                <option value="" selected>Seleccionar Todo</option>
                    ...
                    <div class="filter-block mb-30">
                        <h5 class="medium-heading mb-15">Lenguajes</h5>
                        <div class="form-group select-style select-style-icon">
                            <select class="form-control form-icons select-active" id="language_id" wire:model="language_selected">
                                <option value="" selected>Seleccionar Todo</option>
